...
/** One line under the title, setting the hierarchy: this slide is evidence, not the argument. */
export const MAKING_INTRO =
  'The research is the work. These are the things around it — notes I intend to write, and software that already runs.';
